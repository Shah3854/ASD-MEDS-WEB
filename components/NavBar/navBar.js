            ...
            <div style={{ borderBottom: '1px solid #E9EEF5' }} className={`${styles.navbar}`}>
                ...
                <div className={`${styles.navbar_inner} pageContainer`}>
                    <Link className={`${styles.logo}`} href="/">
                        <img style={{ width: '130px' }} src={isDark ? 'images/asd_meds_logo_white.png' : 'images/asd_meds_logo.png'} />
                    </Link>
                    <Link className={`${styles.logoMobile}`} href="/">
                        <img style={{ width: '130px' }} src={isDark ? 'images/asd_meds_logo_white.png' : 'images/asd_meds_logo.png'} />
                    </Link>
                    {router.asPath == "/about" && <div className={isDark ? styles.headingDark : styles.headingLight}>ASD MEDS</div>}

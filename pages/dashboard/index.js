...
const Dashboard = ({ isDark, setIsDark, toggleDark }) => {
  ...
  const searchHandler = () => {
    ...
    filteredData = filteredData.filter(item => {
      ...
      } else if (criteria === "type_of_disorder") {
        return item.type_of_disorder.toLowerCase().includes(searchValue.toLowerCase());
      }
    ...
    return (
      <div className={`pageContainer ${styles.dashboardContainer}`}>
        ...
        <div className={`${styles.dashboardTextContainer} ${isDark ? "text-white" : ""}`}>
          ...
          <ul>
            <li><img src='images/bullet.png' alt="bullet_check_image" /> Search by scientific or common names to find the perfect plant.</li>
            <li><img src='images/bullet.png' alt="bullet_check_image" /> Dive deep and discover the chemical makeup and anti-disorder compounds in each plant.</li>
            <li><img src='images/bullet.png' alt="bullet_check_image" /> See it to believe it! Immerse yourself in a library of beautiful plant images.</li>
            <li><img src='images/bullet.png' alt="bullet_check_image" /> Unravel the science: Delve into curated research articles for in-depth knowledge.</li>
          </ul>
        </div>
        <div className={styles.searchboxContainer}>
          ...
          <Select 
            ...
            options={[
              ...
              {
                label: "Type of Disorder",
                value: "type_of_disorder",
              },
            ]}
          />
          <Input 
        ...
        >
          {selectedRowData && (
            <Card className=' shadow p-2'>
              ...
              <Row className='mb-2'>
                <Col span={6} className='text-lg font-medium'>Type of Disorder</Col>
                <Col span={1}>:</Col>
                <Col className='text-base font-medium' span={17}>{selectedRowData.type_of_disorder}</Col>
              </Row>
              <Row className='mb-2'>
